...
<head>
    ...
    <title>Register - Minetopia Panel</title>
    ...
    <div class="min-h-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md">
            ...
            <p class="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                Connect your Minecraft account to the panel
            </p>
        </div>
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div>
                        <label for="minecraft_username" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            Minecraft Username
                        </label>
                        <div class="mt-1">
                            <input id="minecraft_username" name="minecraft_username" type="text" required 
                                class="appearance-none block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm dark:bg-gray-700 dark:text-white" 
                                value="{{ old('minecraft_username') }}">
                        </div>
                        <div id="minecraft-preview" class="mt-2">
