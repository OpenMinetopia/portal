    ...
    <div class="space-y-6">
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 p-3 bg-blue-100 dark:bg-blue-500/10 rounded-lg">
                            <x-heroicon-s-archive-box-x-mark class="h-6 w-6 text-blue-600 dark:text-blue-400"/>
                        </div>
                        <div class="ml-4">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-base font-semibold text-gray-900 dark:text-white">Opheffings Aanvragen</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Overzicht van alle opheffings aanvragen</p>
            </div>
                                ...
                                @forelse($requests as $request)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                        <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm sm:pl-3">
                                            <div class="font-medium text-gray-900 dark:text-white">{{ $request->company->name }}</div>
                                            <div class="text-gray-500 dark:text-gray-400">{{ $request->company->kvk_number }}</div>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-3 py-8 text-center">
                                            <div class="flex flex-col items-center">
                                                <x-heroicon-o-archive-box-x-mark class="h-12 w-12 text-gray-400 dark:text-gray-500"/>
