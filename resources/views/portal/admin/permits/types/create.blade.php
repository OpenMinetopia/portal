...
@section('title', 'Nieuw Vergunning Type')
@section('header', 'Nieuw Vergunning Type')
...
@section('content')
    <div class="space-y-6" x-data="formBuilder">
        ...
        <form action="{{ route('portal.admin.permits.types.store') }}" method="POST" class="space-y-6">
            @csrf
