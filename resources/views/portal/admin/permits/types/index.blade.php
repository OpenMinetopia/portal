...
@section('title', 'Vergunning Types')
@section('header', 'Vergunning Types')
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $permitTypes->total() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ $permitTypes->where('is_active', true)->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 p-3 bg-indigo-100 dark:bg-indigo-500/10 rounded-lg">
                            <x-heroicon-s-inbox-stack class="h-6 w-6 text-indigo-600 dark:text-indigo-400" />
                        </div>
                        <div class="ml-4">
                            <h3 class="text-sm font-medium text-gray-500 dark:text-gray-400">Totaal Aanvragen</h3>
                            <p class="text-2xl font-semibold text-gray-900 dark:text-white">{{ \App\Models\PermitRequest::count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div>
                        <h3 class="text-base font-semibold text-gray-900 dark:text-white">Vergunning Types</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Beheer alle beschikbare vergunning types</p>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead>
                                <tr class="bg-gray-50 dark:bg-gray-800/50">
                                    <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400 sm:pl-3">Vergunning</th>
                                    ...
                                    <th scope="col" class="px-3 py-3.5 text-left text-xs font-medium uppercase tracking-wide text-gray-500 dark:text-gray-400">Aanvragen</th>
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-150">
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                                            <span class="inline-flex items-center rounded-md bg-gray-50 px-2 py-1 text-xs font-medium text-gray-700 ring-1 ring-inset ring-gray-600/20 dark:bg-gray-500/10 dark:text-gray-400 dark:ring-gray-500/20">
                                                {{ $type->requests()->count() }} aanvragen
                                            </span>
                                        </td>
                                        <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-3">
                                            <div class="flex justify-end gap-2">
                                                <a href="{{ route('portal.admin.permits.types.edit', $type) }}"
                                                   class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 dark:hover:text-indigo-300">
                                                    Bewerken
                                                </a>
                                                <form action="{{ route('portal.admin.permits.types.destroy', $type) }}" 
                                                      method="POST" 
                                                      class="inline"
                                    ...
                                    <tr>
                                        <td colspan="6" class="px-3 py-8 text-center">
                                            <div class="flex flex-col items-center">
                                                ...
                                                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-white">Geen vergunning types</h3>
                                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                                    Er zijn nog geen vergunning types aangemaakt.
                                                </p>
                                                <div class="mt-6">
                                                    <a href="{{ route('portal.admin.permits.types.create') }}"
                                                       class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 dark:bg-indigo-500 dark:hover:bg-indigo-400">
