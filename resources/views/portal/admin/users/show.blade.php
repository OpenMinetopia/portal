...
@section('header')
    <div class="flex items-center justify-between">
        <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ $user->minecraft_username }}</h1>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
            <div class="px-4 py-5 sm:px-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-base font-semibold text-gray-900 dark:text-white">Account Informatie</h3>
            </div>
            <div class="px-4 py-5 sm:p-6">
                <dl class="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
                    ...
                    <div class="sm:col-span-2">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Rollen</dt>
                                    ...
                                    <div>
                                        <p class="text-sm font-medium text-gray-900 dark:text-white">
                                            ...
                                            @if($account['type'] === 'PRIVATE')
                                                <span class="ml-2 inline-flex items-center rounded-md px-2 py-1 text-xs font-medium bg-purple-50 text-purple-700 ring-1 ring-inset ring-purple-600/20">
                                                    Privé
                                                </span>
                                            @endif
                                        </p>
                                        <p class="mt-1 text-xs text-gray-500">{{ $account['uuid'] }}</p>
                                    </div>
                                    <p class="text-sm font-medium text-gray-900 dark:text-white">
