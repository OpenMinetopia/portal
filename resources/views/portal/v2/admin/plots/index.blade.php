            ...
            <div class="card-hover relative overflow-hidden rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                ...
                <div class="relative p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Totaal Plots</h3>
                            <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format(count($plots)) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-hover relative overflow-hidden rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                ...
                <div class="relative p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Totaal Eigenaren</h3>
                            <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format(collect($plots)->sum(fn($plot) => count($plot['owners']))) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-hover relative overflow-hidden rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                ...
                <div class="relative p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Totaal Leden</h3>
                            <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format(collect($plots)->sum(fn($plot) => count($plot['members']))) }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="p-6 border-b border-gray-200/50 dark:border-gray-700/50">
                    <div class="flex items-center gap-3">
                        <div class="w-10 h-10 bg-gradient-to-r from-emerald-500 to-green-600 rounded-xl flex items-center justify-center">
                            <x-heroicon-s-map class="h-5 w-5 text-white" />
                        </div>
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white">Plots Overzicht</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Beheer alle plots en hun eigenaren</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200/50 dark:divide-gray-700/50">
                            <thead>
                                <tr class="bg-gray-50/50 dark:bg-gray-800/50">
                                    <th scope="col" class="py-4 pl-6 pr-3 text-left text-xs font-bold uppercase tracking-widest text-gray-600 dark:text-gray-400">Plot Naam</th>
                                    <th scope="col" class="px-3 py-4 text-left text-xs font-bold uppercase tracking-widest text-gray-600 dark:text-gray-400">Eigenaren</th>
                                    <th scope="col" class="px-3 py-4 text-left text-xs font-bold uppercase tracking-widest text-gray-600 dark:text-gray-400">Leden</th>
                                    ...
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-all duration-200">
                                        <td class="whitespace-nowrap py-4 pl-6 pr-3 text-sm">
                                            <div class="flex items-center gap-3">
                                                <div class="w-8 h-8 bg-gradient-to-r from-emerald-500 to-green-600 rounded-lg flex items-center justify-center">
                                                    <x-heroicon-s-map-pin class="h-4 w-4 text-white" />
                                                </div>
                                                <span class="font-bold text-gray-900 dark:text-white">{{ $plot['name'] }}</span>
                                            </div>
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                                            <span class="inline-flex items-center rounded-xl px-3 py-1 text-xs font-bold bg-blue-100/80 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300 border border-blue-200/50 dark:border-blue-500/30">
                                                ...
                                                {{ count($plot['owners']) }} eigenaar{{ count($plot['owners']) !== 1 ? 's' : '' }}
                                            </span>
                                        </td>
                                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                                            <span class="inline-flex items-center rounded-xl px-3 py-1 text-xs font-bold bg-purple-100/80 text-purple-700 dark:bg-purple-500/20 dark:text-purple-300 border border-purple-200/50 dark:border-purple-500/30">
                                                ...
                                                {{ count($plot['members']) }} lid{{ count($plot['members']) !== 1 ? 'en' : '' }}
                                            </span>
                                        </td>
                                        ...
                                        <td colspan="4" class="px-6 py-16 text-center">
                                            <div class="flex flex-col items-center">
                                                <div class="w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center mb-4">
                                                    <x-heroicon-o-map class="h-8 w-8 text-gray-400 dark:text-gray-500"/>
                                                </div>
                                                <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-1">Geen plots</h3>
