            ...
            <div class="relative">
                <div class="p-6 border-b border-gray-200/50 dark:border-gray-700/50">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white">Bedrijfs Aanvragen</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Overzicht van alle bedrijfs aanvragen</p>
                        </div>
                    </div>
                </div>
                                ...
                                @forelse($requests as $request)
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-all duration-200">
                                        <td class="whitespace-nowrap py-4 pl-6 pr-3 text-sm">
                                            <div class="font-bold text-gray-900 dark:text-white">{{ $request->name }}</div>
                                        </td>
                                        ...
                                        <td colspan="6" class="px-6 py-16 text-center">
                                            <div class="flex flex-col items-center">
                                                <div class="w-16 h-16 bg-gray-100 dark:bg-gray-700 rounded-2xl flex items-center justify-center mb-4">
                                                    <x-heroicon-o-inbox-stack class="h-8 w-8 text-gray-400 dark:text-gray-500"/>
                                                </div>
