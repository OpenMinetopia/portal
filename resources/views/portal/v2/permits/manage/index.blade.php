...
@section('title', 'Vergunning Aanvragen Beheren')
@section('header', 'Vergunning Aanvragen Beheren')
                    ...
                    <div class="flex items-center">
                        <div class="flex-shrink-0">
                            <div class="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg">
                                <x-heroicon-s-inbox-stack class="h-6 w-6 text-white"/>
                            </div>
                        </div>
                        <div class="ml-4">
                ...
                <div class="relative p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format($stats['pending']) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-hover relative overflow-hidden rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                ...
                <div class="relative p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Goedgekeurd</h3>
                            <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format($stats['approved']) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-hover relative overflow-hidden rounded-2xl bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200/50 dark:border-gray-700/50 shadow-lg">
                ...
                <div class="relative p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider">Afgewezen</h3>
                            <p class="text-3xl font-black text-gray-900 dark:text-white">{{ number_format($stats['denied']) }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="relative">
                <div class="p-6 border-b border-gray-200/50 dark:border-gray-700/50">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-xl font-bold text-gray-900 dark:text-white">Vergunning Aanvragen</h3>
                            <p class="text-sm text-gray-600 dark:text-gray-400">Beheer alle ingediende vergunning aanvragen</p>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200/50 dark:divide-gray-700/50">
                            <thead>
                                <tr class="bg-gray-50/50 dark:bg-gray-800/50">
                                    <th scope="col" class="py-4 pl-6 pr-3 text-left text-xs font-bold uppercase tracking-widest text-gray-600 dark:text-gray-400">Aanvrager</th>
                                    ...
                                    <th scope="col" class="px-3 py-4 text-left text-xs font-bold uppercase tracking-widest text-gray-600 dark:text-gray-400">Behandelaar</th>
                                    ...
                                    <tr class="hover:bg-gray-50/50 dark:hover:bg-gray-700/30 transition-all duration-200">
                                            ...
                                            <div class="flex items-center gap-4">
                                                <div class="relative">
                                                    <img src="https://crafatar.com/avatars/{{ $request->user->minecraft_uuid }}?overlay=true&size=128"
                                                         ...
                                                         class="h-10 w-10 rounded-xl border-2 border-white dark:border-gray-800 shadow-lg">
                                                    <div class="absolute -bottom-1 -right-1 w-4 h-4 bg-emerald-500 rounded-full border-2 border-white dark:border-gray-800"></div>
                                                </div>
                                                <div>
                                                    <div class="font-bold text-gray-900 dark:text-white">{{ $request->user->minecraft_username }}</div>
                                                    <div class="text-sm text-gray-600 dark:text-gray-400">{{ $request->user->name }}</div>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm">
                                            <span @class([
                                                ...
                                                'bg-yellow-500/20 text-yellow-700 dark:text-yellow-300 border-yellow-500/30' => $request->isPending(),
                                                'bg-emerald-500/20 text-emerald-700 dark:text-emerald-300 border-emerald-500/30' => $request->isApproved(),
                                                'bg-red-500/20 text-red-700 dark:text-red-300 border-red-500/30' => $request->isDenied(),
                                            ])>
                                        ...
                                        <td class="whitespace-nowrap px-3 py-4 text-sm text-gray-600 dark:text-gray-400">
                                            @if($request->handler)
                                                <div class="flex items-center gap-2">
                                                    <div class="w-6 h-6 bg-gradient-to-r from-gray-400 to-gray-500 rounded-lg flex items-center justify-center">
                                                        <span class="text-xs font-bold text-white">{{ substr($request->handler->name, 0, 1) }}</span>
                                                    </div>
                                        ...
                                        <td class="relative whitespace-nowrap py-4 pl-3 pr-6 text-right text-sm font-medium">
                                            <a href="{{ route('portal.permits.manage.show', $request) }}"
